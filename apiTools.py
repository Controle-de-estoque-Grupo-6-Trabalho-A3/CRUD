...
def organize_case_list_deaths(case_list):
    sorted_case_list = sorted(case_list, key=lambda x: x['deaths'], reverse=False)
    return sorted_case_list

def organize_case_list_deaths_desc(case_list):
    sorted_case_list = sorted(case_list, key=lambda x: x['deaths'], reverse=True)
    return sorted_case_list
